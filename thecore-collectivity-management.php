...
define( 'THECORE_COLLECTIVITY_MANAGEMENT_VERSION', '1.0.1-beta.34' );
...
require_once THECORE_COLLECTIVITY_MANAGEMENT_DIR . 'includes/modules/interface-thecore-collectivity-module.php';
require_once THECORE_COLLECTIVITY_MANAGEMENT_DIR . 'includes/modules/abstract-thecore-collectivity-module.php';
require_once THECORE_COLLECTIVITY_MANAGEMENT_DIR . 'includes/modules/class-thecore-collectivity-module-registry.php';
...
add_action( 'plugins_loaded', array( 'TheCore_Collectivity_Management', 'boot' ), 20 );

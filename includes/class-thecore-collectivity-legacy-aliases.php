...
$thecore_collectivity_legacy_aliases = array(
...
foreach ( $thecore_collectivity_legacy_aliases as $legacy_class => $current_class ) {
	if ( class_exists( $current_class, false ) && ! class_exists( $legacy_class, false ) ) {
		class_alias( $current_class, $legacy_class );
	}
}

unset( $thecore_collectivity_legacy_aliases, $legacy_class, $current_class );
